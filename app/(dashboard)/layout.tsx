  ...
  return (
    <div style={{ fontFamily: 'var(--font-inter), sans-serif' }}>
      <style>{`
        ...
        .sidebar { width: 230px; min-width: 230px; background: #fff; display: flex; flex-direction: column; height: 100vh; position: fixed; left: 0; top: 0; z-index: 100; border-right: 1px solid rgba(123,79,216,0.1); box-shadow: 2px 0 12px rgba(45,27,110,0.04); }
